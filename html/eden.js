...
function testToken(pathname,x=true){
  ...
  if(pathname=="/webpages/2-1/index.html")alert("本实验已停止提交！\n目前可正常操作实验流程，但无法再修改成绩。");
  if(pathname=="/webpages/2-2/index.html")alert("本实验已停止提交！\n目前可正常操作实验流程，但无法再修改成绩。");
  if(pathname=="/webpages/2-3/index.html")alert("本实验已停止提交！\n目前可正常操作实验流程，但无法再修改成绩。");
}
//登出
